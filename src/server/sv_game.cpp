...
void SV_LocateGameData(
    sharedEntity_t *gEnts, int numGEntities, int sizeofGEntity_t, playerState_t *clients, int sizeofGameClient)
{
    sv.gentities = gEnts;
...
intptr_t SV_GameSystemCalls(intptr_t *args)
{
    switch (args[0])
    {
        ...
        case G_FS_GETFILTEREDFILES:
            return FS_GetFilteredFiles(
                (const char *)VMA(1), (const char *)VMA(2), (char *)VMA(3), (char *)VMA(4), args[5]);
        case G_FS_SEEK:
        ...
        case G_TRACE:
            SV_Trace((trace_t *)VMA(1), (const vec_t *)VMA(2), (vec_t *)VMA(3), (vec_t *)VMA(4), (const vec_t *)VMA(5),
